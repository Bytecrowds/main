    ...
    <>
      ...
      <Flex flexDirection="column" marginTop={{
        ...
        <Flex flexDirection="row" width="400px" marginTop={{
          ...
          <Text marginLeft="10px" fontSize="14px">by <Link href="https://www.linkedin.com/in/tudor-zg%C3%AEmb%C4%83u-a85274234/" color="orange.200" isExternal>Tudor Zgîmbău</Link>
        </Flex>
      </Flex>
    </>
  )
